...
void state0_idle() {
    ...
    if (millis() - timeWhenDoorClosed < state0_occupant_detection_timer && ((unsigned long)checkINS.signalMedian > ins_threshold) &&
        ...
        publishStateTransition(0, 1, checkDoor.doorStatus, checkINS.signalMedian);
...
void state1_15sCountdown() {
    ...
    if ((unsigned long)checkINS.signalMedian > 0 && (unsigned long)checkINS.signalMedian < ins_threshold) {
        ...
        publishStateTransition(1, 0, checkDoor.doorStatus, checkINS.signalMedian);
        ...
        publishStateTransition(1, 2, checkDoor.doorStatus, checkINS.signalMedian);
...
void state2_duration() {
    ...
    if ((unsigned long)checkINS.signalMedian > 0 && (unsigned long)checkINS.signalMedian < ins_threshold) {
        ...
        publishStateTransition(2, 3, checkDoor.doorStatus, checkINS.signalMedian);
        ...
        publishStateTransition(2, 0, checkDoor.doorStatus, checkINS.signalMedian);
...
void state3_stillness() {
    ...
    if ((unsigned long)checkINS.signalMedian > ins_threshold) {
        ...
        publishStateTransition(3, 2, checkDoor.doorStatus, checkINS.signalMedian);
        ...
        publishStateTransition(3, 0, checkDoor.doorStatus, checkINS.signalMedian);
        ...
        publishStateTransition(3, 3, checkDoor.doorStatus, checkINS.signalMedian);
...
void getHeartbeat() {
    ...
    if (lastHeartbeatPublish == 0 || (doorMessageReceivedFlag && ((millis() - doorHeartbeatReceived) >= HEARTBEAT_PUBLISH_DELAY)) ||
        ...
        bool isINSZero = (checkINS.signalMedian < 0.000001);
