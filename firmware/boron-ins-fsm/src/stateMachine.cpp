...
>>>>>>> 779f92df87eb9ef6fef4af4f56c80ed4f493b3bb
  ...
  if ((unsigned long)checkINS.iAverage > 0 &&
    ...
    Log.warn(
        "See duration alert, going from state2_duration to idle after alert "
        "publish");
    publishStateTransition(2, 0, checkDoor.doorStatus, checkINS.iAverage);
    saveStateChange(2, 4);
...
>>>>>>> 779f92df87eb9ef6fef4af4f56c80ed4f493b3bb
  ...
  if ((unsigned long)checkINS.iAverage > ins_threshold) {
    Log.warn(
        "motion spotted again, going from state3_stillness to state2_duration");
    ...
    Log.warn(
        "See duration alert, going from state3 to idle after alert publish");
    publishStateTransition(3, 0, checkDoor.doorStatus, checkINS.iAverage);
    saveStateChange(3, 4);
    Log.error("Duration Alert!!");
    Particle.publish("Duration Alert", "duration alert", PRIVATE);
