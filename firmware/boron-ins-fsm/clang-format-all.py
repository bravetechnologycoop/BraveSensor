...
# clang-format-all.py
#
# Formats all files with filetype .cpp, .ino or .h in the src and test directories using clang-format. 
...
os.system("find src -iname *.h -o -iname *.cpp -o -iname *.ino | xargs clang-format-12 -i")
os.system("find test -iname *.h -o -iname *.cpp -o -iname *.ino | xargs clang-format-12 -i")