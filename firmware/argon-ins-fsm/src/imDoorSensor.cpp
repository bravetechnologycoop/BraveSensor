...
void logAndPublishDoorData(doorData previousDoorData, doorData currentDoorData){
  ...
  Particle.publish("Door Sensor Data", doorPublishBuffer, PRIVATE);
...
void logAndPublishDoorWarning(doorData previousDoorData, doorData currentDoorData){
  ...
  Particle.publish("Door Sensor Warning", doorPublishBuffer, PRIVATE);
  Log.warn("published Door Sensor warning, prev door byte = 0x%02X, curr door byte = 0x%02X",previousDoorData.controlByte, currentDoorData.controlByte);
