...
BEGIN
    ...
    IF migrationId - lastSuccessfulMigrationId = 1 THEN
        ...
        CREATE TYPE notification_type_enum AS ENUM ('DOOR_LOW_BATTERY', 'DOOR_TAMPERED', 'DOOR_INACTIVITY', 'DEVICE_DISCONNECTED', 'DEVICE_DISCONNECTED_REMINDER', 'DOOR_DISCONNECTED', 'DOOR_DISCONNECTED_REMINDER', 'DEVICE_RECONNECTED', 'DOOR_RECONNECTED');
